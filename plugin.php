...
/*  Copyright 2018 iRemoteWP.com  (email : support@iremotewp.com)
...
// Don't activate on anything less than PHP 5.3.0
if ( version_compare( phpversion(), '5.3.0', '<' ) ) {
	...
	if ( isset( $_GET['action'] ) && ( $_GET['action'] == 'activate' || $_GET['action'] == 'error_scrape' ) )
		die( __( 'iRemoteWP requires PHP version 5.3.0 or greater.', 'iremotewp' ) );
...
if ( version_compare( get_bloginfo( 'version' ), '3.1', '>=' ) ) {
	...
	require_once( IREMOTE_PLUGIN_PATH . '/lib/Dropbox/autoload.php' );
...
function iremo_catch_api_call() {
	...
	require_once( IREMOTE_PLUGIN_PATH . '/inc/iremote.sweep.php' );
