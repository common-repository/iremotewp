		...
		if($_SESSION['whenS3']['time'] < time()){
        	...
        	$_SESSION['whenS3']['sk']			= $_POST['sk'];
					...
					wp_remote_post( IREM_API_URL . 'dropbox/upload.php', array(
						...
						'blocking' => true,
						'headers' => array(),
						'body' => array( 'sk'=> get_option( 'irem_verify_key' ),
										 'filename' => $_SESSION['whenS3']['filename'],
										 'upload_id' => $_SESSION['whenS3']['upload_id'] ,
										 'offset' => $uploaded,
										 'filetotal' => $_SESSION['whenS3']['filetotal'],
										 'parameter' => $_SESSION['whenS3']['sk'] ),
										 'cookies' => array()
					    )
					);
